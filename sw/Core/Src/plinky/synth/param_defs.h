...
#define INDEX_TO_RAW(index, range) ((((index) << 10) + ((index) >= 0 ? (range) - 1 : 0)) / (range))
...
const static RangeType range_type[NUM_PARAMS] = {
   ...
   [P_ENV_LVL1] = R_UVALUE,    [P_ATTACK1] = R_UVALUE,      [P_DECAY1] = R_UVALUE,        [P_SUSTAIN1] = R_UVALUE,    [P_RELEASE1] = R_UVALUE,      [P_ROOT_NOTE] = R_ROOTNT,     // Envelope 1
   [P_ENV_LVL2] = R_UVALUE,    [P_ATTACK2] = R_UVALUE,      [P_DECAY2] = R_UVALUE,        [P_SUSTAIN2] = R_UVALUE,    [P_RELEASE2] = R_UVALUE,      [P_ENV2_UNUSED] = R_BINARY,   // Envelope 2 / FM mod wav (alias)
   ...
   [P_RVB_SEND] = R_UVALUE,    [P_RVB_TIME] = R_UVALUE,     [P_SHIMMER] = R_UVALUE,       [P_RVB_WOBBLE] = R_UVALUE,  [P_RVB_UNUSED] = R_SVALUE,    [P_SWING] = R_SVALUE,         // Reverb / FM env (alias)
   ...
   [P_IN_LVL] = R_UVALUE,      [P_IN_WET_DRY] = R_UVALUE,   [P_SYS_UNUSED1] = R_UNUSED,   [P_MIX_UNUSED2] = R_UVALUE, [P_MIX_UNUSED3] = R_UNUSED,   [P_MIX_WIDTH] = R_SVALUE,     // Mixer 2 / FM feedback (alias)
};
...
const static Preset init_params = {
    ...
    .params = {
        ...
        [P_ENV_LVL1] = {RAW_HALF},  [P_ATTACK1] = {RAW_EIGHTH},                                 [P_DECAY1] = {RAW_QUART},                           [P_SUSTAIN1] = {RAW_SIZE},      [P_RELEASE1] = {RAW_EIGHTH},                [P_ROOT_NOTE] = {INDEX_TO_RAW(12, 25)}, // Envelope 1
        [P_ENV_LVL2] = {RAW_HALF},  [P_ATTACK2] = {RAW_EIGHTH},                                 [P_DECAY2] = {RAW_QUART},                           [P_SUSTAIN2] = {RAW_SIZE},      [P_RELEASE2] = {RAW_EIGHTH},                [P_ENV2_UNUSED] = {0},               // Envelope 2 / FM mod wav (alias)
        ...
        [P_RVB_SEND] = {RAW_QUART}, [P_RVB_TIME] = {RAW_HALF},                                  [P_SHIMMER] = {RAW_QUART},                          [P_RVB_WOBBLE] = {RAW_QUART},   [P_RVB_UNUSED] = {0},                       [P_SWING] = {0},                    // Reverb / FM env (alias)
        ...
        [P_Y_SCALE] = {RAW_HALF},   [P_Y_OFFSET] = {0},                                         [P_Y_DEPTH] = {0},                                  [P_Y_RATE] = {-630},            [P_Y_SHAPE] = {0},                          [P_Y_SYM] = {0},                    // LFO Y
        [P_SYN_LVL] = {RAW_HALF},   [P_SYN_WET_DRY] = {RAW_HALF},                               [P_HPF] = {0},                                      [P_MIX_UNUSED1] = {},           [P_MIX_UNUSED4] = {},                       [P_VOLUME] = {0},                   // Mixer 1
        [P_IN_LVL] = {RAW_HALF},    [P_IN_WET_DRY] = {RAW_HALF},                                [P_SYS_UNUSED1] = {},                               [P_MIX_UNUSED2] = {0},          [P_MIX_UNUSED3] = {},                       [P_MIX_WIDTH] = {RAW_SIZE * 7 / 16},// Mixer 2 / FM feedback (alias)
    }
};